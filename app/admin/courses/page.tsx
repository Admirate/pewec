...
export default function AdminCoursesPage() {
  ...
  const handleSave = async () => {
    ...
    if (!formData.rep_email.trim()) { setFormError("Rep email is required"); return; }
                  ...
                  <table className="w-full">
                    <thead className="border-b border-gray-200">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Rep Email</th>
