...
/**
 * Send an email using the module's configured SMTP transporter.
 *
 * If sending fails, the error is logged with recipient and subject details and not rethrown.
 *
 * @param to - Recipient email address or a comma-separated list of addresses
